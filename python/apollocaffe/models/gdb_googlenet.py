...
def googlenet_layers():
    ...
    googlenet_layers = [
        ...
        layers.Convolution(name="gdb_conv2/3x3", bottoms=["conv2/3x3_reduce"], param_lr_mults=conv_lr_mults, param_decay_mults=conv_decay_mults, kernel_dim=(3, 3), pad=1, weight_filler=weight_filler, bias_filler=bias_filler, num_output=192),
        layers.ReLU(name="conv2/relu_3x3", bottoms=["gdb_conv2/3x3"], tops=["conv2/3x3"]),
